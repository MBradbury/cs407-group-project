...
\lstdefinelanguage{Hoppy}{
    morekeywords={all,function,as,returning,in,using},
    sensitive=true,
}
\lstset{
    language=Hoppy,
...
%
    keywords=[3]{int,float},
    keywordstyle=[3]\color{YellowOrange},
%
    keywords=[4]{Neighbours,abs,mean,max,min,sum,len},
...
\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/Common/net/multipacket.h}
\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/Common/net/multipacket.c}
...
\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalLocalPeriodic/pelp.h}
\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalLocalPeriodic/pelp.c}


\subsection{PELE}

\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalLocalEvent/pele.h}
\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalLocalEvent/pele.c}

\subsection{PEGP}

\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalGlobalPeriodic/pegp.h}
\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalGlobalPeriodic/pegp.c}


\subsection{PEGE}

\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalGlobalEvent/pege.h}
\inputminted[linenos=true,tabsize=3,fontsize=\small,frame=lines,framesep=2mm]{c}{../Algorithms/PredEvalGlobalEvent/pege.c}
