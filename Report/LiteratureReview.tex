...
Primary issues
- GENESI considers energy constraints
- Solutions that will harvest energy based on ambient temperatur, vibration, motion and solar energy. Implement an efficient method for energy harvesting from multiple independent sources.

Primary Objectives
- design of power-scalable, high efficiency DC-DC converters and low-drop-ou regulators

Critical
- Selection of transducer to adopt because operating point of max power may change
- investivate the best combination of batteries and supercapacitors to responde to good dynamics to peaks in the suppy demands
- Design of distributed scheme will reduce power losses. From heterogeneous to different storage systems.

Factors that will reduce energy consumptions
- Radio triggering, information fusion/filtering and interference avoidance
- Selectively activating and deactivating nodes for enerygy optimization. - Considers heterogenous networks.
- Task allocation - deciding which sensor to complete a task based on several factors such as node residual energy, field coverage, type of sensing
