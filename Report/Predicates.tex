...
%
	...
	~ & \oo & \pn{predicate} \\
%
	\pn{predicate} & \pp & \sm{@}\sm{(}\pn{variable} \ww \sm{:} \ww \pn{variable} \ww \sm{\mytilde} \pn{predicate} \sm{)}\\
	~ & \oo & \sm{\#}\sm{(}\pn{variable} \ww \sm{:} \ww \pn{variable} \ww \sm{\mytilde} \pn{predicate} \sm{)} \\
...
%
	...
	\pn{number} & \pp & \pn{digit} \oo \pn{digit}\pn{number} \\
