...
\subsection{PRINCE Methods}

Brief into as to how we applied the PRINCE methods to our project

\subsubsection{Plan and Process}
...
Develop the below points in a table

\begin{enumerate}
	\item Software
	Contiki, Simulator (Cooja), VM, GUI, etc
	
	\item Hardware
	DSC workstations, network sensors (appendix), laptops.
\end{enumerate}
