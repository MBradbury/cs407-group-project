...
\begin{enumerate}
	...
	\item Predicate evaluation
		\begin{enumerate}
			\item Hardcode of response handling
...
By the end of the first term, the scope of the project reached a more defined level as we have decided what is to be implemented and what has been disregarded from the provisional list of algorithms. This was demonstrated in our first delivery - the poster presentation, where we had to chance to explain our project at a high level to our supervisors and other professors.
...
In the second term, we continued following the evolutionary process model but at a more relaxed approach and less meetings with the supervisor was needed. However, the next important issue to tackle was ensuring that the project will be completed in time. This required the effective scheduling of tasks and prioritising work force to the critical tasks. By the 3rd quarter of the term, progress had fallen to a halt due the high number of coursework deadlines and this meant that team members where preoccupied with these work. To address the issue, a meeting was held prior to the halt where we discussed our recovery plan once everyone was done with other courseworks. This allowed team members to continue working where they left off and avoid any delays.
...
\begin{table}[H]
	...
	Develop Predicate Language Runtime & ~ & ~ & ~ & ~ & ~ & 2\\
	Testing and Adapting to Physical Nodes & 1 & ~ & ~ & ~ & 0.5 & ~\\
	Message Logging & ~ & ~ & ~ & 1 & ~ & ~\\
	Poster Creation and Presentation preparation & 0.5 & 0.5 & 0.5 & 0.5 & 0.5 & 0.5\\
	...
	Modify Algorithms to Selectively Evaluate Predicates & 2 & ~ & ~ & ~ & ~ & ~\\
	Performance Testing & 1 & ~ & ~ & ~ & ~ & ~\\
	Testing and Adapting to Physical Nodes & 4 & ~ & ~ & ~ & ~ & ~\\
	Report Writing & 2 & ~ & ~ & ~ & ~ & 3\\
