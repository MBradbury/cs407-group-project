...
\begin{itemize}
	...
	\item Implementations of various distrubted algorithms to test the visualizer and the predicate checker.
	\item \textbf{TODO}
\end{itemize}
...
\begin{itemize}
	...
	\item Visulaisation of active clusters within the sensor network.
	\item Visulaisation of messages flowing through the network, along with node logs of the information processed.
\end{itemize}

\subsection{Predicate Checker}
\begin{itemize}
	\item Fuctionality to query nodes to see if a given predicate holds.
	\item Visulaisation of nodes that are breaking a given predicate during runtime.
\end{itemize}
...
\begin{itemize}
	...
	\item Computers able to run the simulators
\end{itemize}
